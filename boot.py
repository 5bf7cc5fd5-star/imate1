...
APP_INJECT = """
<link rel=\"stylesheet\" href=\"/static/edge-fix.css?v=24\">
<script src=\"/static/market-data.js?v=24\"></script>
<script src=\"/static/lock-nav.js?v=24\"></script>
<script src=\"/static/nav-rules.js?v=24\"></script>
<script src=\"/static/member-id.js?v=24\"></script>
<style id=\"fullbleed-24\">
...
ADMIN_INJECT = """
<script src=\"/static/staff-admin.js?v=24\"></script>
"""
...
for name in ("index.html", "frontend.html"):
    ...
    if p.exists():
        ...
        new = inject_once(new, "fullbleed-24", APP_INJECT)
        if new != old:
