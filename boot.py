...
INJECT = """
<link rel=\"stylesheet\" href=\"/static/login-tight.css?v=33\">
<script src=\"/static/login-tight.js?v=33\"></script>
<script src=\"/static/market-data.js?v=33\"></script>
<script src=\"/static/lock-nav.js?v=33\"></script>
<script src=\"/static/nav-rules.js?v=33\"></script>
<script src=\"/static/member-id.js?v=33\"></script>
<script src=\"/static/tx-history.js?v=33\"></script>
"""
...
for name in ("index.html", "frontend.html"):
    ...
    if p.exists():
        ...
        new = inject_once(old, "login-tight.css?v=33", INJECT)
