...
APP_INJECT = """
<link rel=\"stylesheet\" href=\"/static/edge-fix.css?v=26\">
<script src=\"/static/market-data.js?v=26\"></script>
<script src=\"/static/lock-nav.js?v=26\"></script>
<script src=\"/static/nav-rules.js?v=26\"></script>
<script src=\"/static/member-id.js?v=26\"></script>
<script src=\"/static/tx-history.js?v=26\"></script>
<style id=\"fullbleed-26\">
...
ADMIN_INJECT = """
<script src=\"/static/staff-admin.js?v=26\"></script>
"""

def inject_once(text, needle, blob):
    if needle in text:
        return text.replace("staff-admin.js?v=25", "staff-admin.js?v=26").replace("fullbleed-25", "fullbleed-26")
    if "</body>" in text:
...
for name in ("index.html", "frontend.html"):
    ...
    if p.exists():
        ...
        new = inject_once(new, "fullbleed-26", APP_INJECT)
        if new != old:
