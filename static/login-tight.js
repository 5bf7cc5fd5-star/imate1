(function(){
  function mount(){
    ...
    document.getElementById("fbForgotBtn").onclick=function(){ box.classList.add("hidden"); if(typeof openForgotPassword==="function") openForgotPassword(); };
    document.getElementById("fbCreateBtn").onclick=function(){ box.classList.add("hidden"); if(typeof switchAuth==="function") switchAuth("signup"); };
    document.getElementById("fbBackBtn").onclick=function(){ box.classList.remove("hidden"); if(typeof switchAuth==="function") switchAuth("login"); };
  }
