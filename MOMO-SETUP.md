# MTN MoMo Collection — connect to Own Club
...
| `MTN_MOMO_CALLBACK_URL` | `https://ownclubshares.com/api/momo/webhook` |
...
3. Set callback to https://ownclubshares.com/api/momo/webhook
4. Redeploy
